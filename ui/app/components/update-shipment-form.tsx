...
import { ShipmentStatus, type ShipmentRead, type ShipmentUpdate } from "~/lib/client"
...
export function UpdateShipmentForm({
    ...
    shipment,
    ...props
}: { shipment?: ShipmentRead | null, onScan: (id: string) => void } & React.ComponentPropsWithoutRef<"div">) {
    ...
    return (
        <div className={cn("flex flex-col gap-6 p-8 max-w-160", className)} {...props}>
